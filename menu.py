        ...
        for tab in tabs:
            try:
                ...
                WebDriverWait(table, 30).until(EC.any_of(EC.presence_of_element_located((By.XPATH, "//div[@class='row menu-period-dropdowns']")),
                                                         EC.text_to_be_present_in_element((By.XPATH, "div/div[@class='loading-content_loadingText_22OQi']"),
                                                                                          "Sorry, we weren't able to find menus for this location for the day you selected."))) # TODO fix this and add retry
            except:
                continue
